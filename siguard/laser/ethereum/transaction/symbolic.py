...
from siguard.laser.ethereum.cfg import Node, Edge, JumpType
from siguard.laser.ethereum.state.account import Account
from siguard.laser.ethereum.state.calldata import SymbolicCalldata
...
from siguard.laser.ethereum.transaction.transaction_models import (
    MessageCallTransaction,
    ContractCreationTransaction,
    tx_id_manager,
    BaseTransaction,
)
from siguard.laser.smt import symbol_factory, Or, Bool, BitVec
from siguard.support.support_args import args as cmd_args
...
def execute_message_call(
    ...
    for open_world_state in open_states:
        if open_world_state[callee_address].deleted:
            log.info("Can not execute dead contract, skipping.")
            continue
