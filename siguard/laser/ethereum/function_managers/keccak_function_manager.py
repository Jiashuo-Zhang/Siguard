...
from siguard.support.support_utils import sha3
...
class KeccakFunctionManager:
    ...
    def get_function(self, length: int) -> Tuple[Function, Function]:
        ...
        return func, inverse
    def get_sha256_function(self, length: int) -> Tuple[Function, Function]:
        """
        Returns the sha256 functions for the corresponding length
        :param length: input size
        :return: tuple of keccak and it's inverse
        """
        try:
            ...
            func = Function("sha256_{}".format(length), [length], 256)
            inverse = Function("sha256_{}-1".format(length), [256], length)
            self.store_function[length] = (func, inverse)
            self.hash_result_store[length] = []
        return func, inverse
    def get_RIPEMD160_function(self, length: int) -> Tuple[Function, Function]:
        """
        Returns the sha256 functions for the corresponding length
        :param length: input size
        :return: tuple of keccak and it's inverse
        ...
        try:
            ...
            func = Function("ripemd160_{}".format(length), [length], 160)
            inverse = Function("ripemd160_{}-1".format(length), [160], length)
            self.store_function[length] = (func, inverse)
            self.hash_result_store[length] = []
        return func, inverse
    ...
    def create_keccak(self, data: BitVec) -> BitVec:
        ...
        return func(data)
    def create_sha256(self, data: BitVec) -> BitVec:
        """
        Creates Keccak of the data
        :param data: input
        :return: Tuple of keccak and the condition it should satisfy
        """
        length = data.size()
        func, _ = self.get_sha256_function(length)
