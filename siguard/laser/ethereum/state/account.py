...
from siguard.laser.smt import Array, K, BitVec, simplify, BaseArray, If, Bool
    ...
    def __getitem__(self, item: BitVec) -> BitVec:
        ...
        if (
            ...
            try:
                ...
                log.info("Couldn't read storage at %s: %s", item, e)
        x=storage[item]
