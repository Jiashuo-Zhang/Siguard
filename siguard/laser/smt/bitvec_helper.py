...
import z3
import logging
from siguard.laser.smt.bool import Bool, Or
from siguard.laser.smt.bitvec import BitVec
from siguard.laser.smt.array import BaseArray, Array
...
def Concat(*args: Union[BitVec, List[BitVec]]) -> BitVec:
    ...
    nraw = z3.Concat([a.raw if isinstance(a,BitVec) else a for a in bvs])
