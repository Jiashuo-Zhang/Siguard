...
from siguard.solidity.soliditycontract import SolidityContract
from siguard.analysis.swc_data import SWC_TO_TITLE
...
from siguard.support.signatures import SignatureDB
...
class Issue:
    ...
    def __init__(
        ...
        self.description = "%s" % (description_head)
...
class Report:
    ...
    environment = Environment(
        loader=PackageLoader("siguard.analysis"), trim_blocks=True
    )
