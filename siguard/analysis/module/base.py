...
class DetectionModule(ABC):
    ...
    def execute(self, target: GlobalState) -> Optional[List[Issue]]:
        """The entry point for execution, which is being called by siguard.
        ...
        log.info("Entering analysis module: {}".format(self.__class__.__name__))
        ...
        log.info("Exiting analysis module: {}".format(self.__class__.__name__))
        log.debug(result)
