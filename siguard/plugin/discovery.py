...
from siguard.plugin.interface import MythrilPlugin
...
class PluginDiscovery(object, metaclass=Singleton):
    ...
    # Installed plugins structure. Retrieves all modules that have an entry point for siguard.plugins
    _installed_plugins = None  # type: Optional[Dict[str, Any]]

    def init_installed_plugins(self):
        self._installed_plugins = {
            entry_point.name: entry_point.load()
            for entry_point in pkg_resources.iter_entry_points("siguard.plugins")
        }
